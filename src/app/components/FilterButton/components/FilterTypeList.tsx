    ...
    <div className="flex flex-col gap-2">
      {filterTypes.map((type) => (
        <button
          ...
          className={`text-sm text-gray-600 py-1 hover:bg-gray-100 focus:bg-blue-100 focus:border-l-2 border-blue-400 focus:text-blue-500`}
        >
      ...
      <button
        ...
        className="text-sm text-gray-600 py-1 font-bold hover:bg-gray-100"
      >
        Clear Filters
      </button>
    </div>
