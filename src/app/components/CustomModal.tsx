...
export const CustomModal = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex fixed inset-0 bg-gray-500/75 transition-opacity min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0"
        onClick={(e) => {
      ...
      >
        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          ...
          <div
            ...
            className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 flex items-center justify-start"
          >
